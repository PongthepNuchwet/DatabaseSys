...
CREATE TABLE IF NOT EXISTS public.sailors (
    ...
    CONSTRAINT sailors_rating_check CHECK (
        rating >= 1
        AND rating <= 10
    )
);
...
CREATE TABLE IF NOT EXISTS public.reserves (
    ...
    CONSTRAINT foreign_boats_bid FOREIGN KEY (bid) REFERENCES public.boats (bid) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION NOT VALID,
    CONSTRAINT foreign_sailors_sid FOREIGN KEY (sid) REFERENCES public.sailors (sid) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
);
--
...
--
INSERT INTO public.sailors (sid, sname, rating, age)
...
--
INSERT INTO public.boats (bid, bname, color)
...
--
INSERT INTO public.reserves (sid, bid, day)
...
INSERT INTO public.reserves (sid, bid, day)
VALUES (31, 102, '1998-10-11');
INSERT INTO public.reserves (sid, bid, day)
VALUES (31, 103, '1998-06-11');
INSERT INTO public.reserves (sid, bid, day)
VALUES (31, 104, '1998-12-11');
INSERT INTO public.reserves (sid, bid, day)
VALUES (64, 101, '1998-05-09');
INSERT INTO public.reserves (sid, bid, day)
VALUES (64, 102, '1998-08-09');
INSERT INTO public.reserves (sid, bid, day)
VALUES (74, 103, '1998-08-09');
-- Table: public.sailors
