...
SELECT S.sid, S.sname  FROM sailors S , reserves R, boats B  WHERE S.sid = R.sid AND R.bid = B.bid AND B.color = 'red' ;
...
SELECT B.bid ,B.color FROM sailors S JOIN reserves R ON S.sid = R.sid JOIN boats B  ON R.bid = B.bid WHERE S.sname = 'Lubber' ;
